...
Не всякий репозиторий — программа. Подборки ссылок, конспекты и шпаргалки
определяются отдельно: сначала объяснимой эвристикой (манифест сборки, доля
текстовых файлов, плотность ссылок в README), затем моделью, которая видит
README и перепись каталогов. Для материала ревью кода не запрашивается, а
вместо оценки страница пишет «Полезный материал» и рассказывает, о чём он.
...
- [x] Этап 20 — чтение по всем каталогам, все ветки в дереве, жанр «материал»
