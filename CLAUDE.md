...
- [x] Этап 28 — раздел «Статьи» (/learn): уровни Junior/Middle/Senior, время чтения считается по тексту, поиск и фильтры; у каждой статьи своя зацикленная ЧБ 8-битная сцена на карточке и 2–3 SVG-иллюстрации внутри; девять статей (коммиты, лицензия, тесты, маленькие PR, цепочка поставки CI и первые четыре)
