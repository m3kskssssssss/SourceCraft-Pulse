...
const CATEGORY_NOTES: Partial<Record<CategoryKey, string>> = {
  security:
    'Только SourceCraft AppSec. Его результаты платформа отдаёт лишь участникам репозитория, поэтому у публичных репозиториев категория — «нет данных» у всех одинаково и места в рейтинге не меняет. Приватный репозиторий считается по токену владельца.',
  code:
