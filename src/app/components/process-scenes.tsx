...
export const PROCESS_STEPS: ProcessStep[] = [
  ...
  },
  {
    ...
    text: 'Балл безопасности — только по данным SourceCraft AppSec. Для справки сверяем lock-файлы с открытой базой OSV.dev — на балл это не влияет — и ищем в истории строки, похожие на ключи и пароли.',
    Scene: SecurityScene,
  },
  {
    key: 'ai',
