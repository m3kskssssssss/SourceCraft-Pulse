...
// AppSec. Они видны лишь участникам репозитория, поэтому провайдер ходит в
// AppSec с токеном владельца; без него — «нет данных», и категория честно
// исключается из расчёта, а не подменяется своим сканом.
//
